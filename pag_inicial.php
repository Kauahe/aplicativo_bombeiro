...
<body>
    ...
    <br><br><br>
    <div class="dupla1">
        <a href="sinaisvitais.html">  <div class="op3">
            <img src="img/ft 5.png" width="70px">
            <p><b>SINAIS <br> VITAIS</b></p>
        </div></a>
        <a href="problemas.html"> <div class="op4">
    ...
    <div class="dupla1">
        ...
        <a href="traumaAdulto.html"> <div class="op6">
